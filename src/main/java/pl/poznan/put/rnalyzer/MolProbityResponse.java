...
public record MolProbityResponse(Structure structure) {
    @JsonIgnoreProperties(ignoreUnknown = true)
    public record Structure(Description description, String clashscore, String pctRank,
                          String rankCategory, String pctProbablyWrongSugarPuckers,
                          String probablyWrongSugarPuckersCategory,
                          String pctBadBackboneConformations,
                          String badBackboneConformationsCategory,
                          String pctBadBonds, String badBondsCategory,
                          String pctBadAngles, String badAnglesCategory) {
    }
