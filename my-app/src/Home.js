              ...
              label={
                ...
                >
                  <span>
                    ...
                    <Tooltip title="Filter input models based on structural quality assessed by MolProbity. Choose ‘No filter’ to include all models, ‘Clashscore filter’ to exclude models with poor clash scores, or ‘Strict filter’ to accept only models with good scores for clashes, bonds, and angles.">
                      <QuestionCircleOutlined
                        style={{ position: "relative", zIndex: 999 }}
                      />
                    </Tooltip>
